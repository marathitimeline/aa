    ...
    <div class="dash">
        <div class="dash-nav dash-nav-dark">
            ...
            <nav class="dash-nav-list">
                ...
                <?php 
                $directoryURI =basename($_SERVER['SCRIPT_NAME']);
                if($directoryURI=="manage_img_category.php"){?>
                <div class="dash-nav-dropdown show" class="dash-nav-dropdown">
                <a href="manage_img_category.php" class="dash-nav-item" style="color: #ffffff">
                <i class="fas fa-th-large"></i> Image Category </a>
                </div>
                <?php }else{?>
                <div class="dash-nav-dropdown" class="dash-nav-dropdown">
                <a href="manage_img_category.php" class="dash-nav-item">
                <i class="fas fa-th-large"></i> Image Category </a>
                </div>
                ...
                <?php 
                $directoryURI =basename($_SERVER['SCRIPT_NAME']);
                if($directoryURI=="manage_quotes.php"){?>
                <div class="dash-nav-dropdown show" class="dash-nav-dropdown">
                <a href="manage_quotes.php" class="dash-nav-item" style="color: #ffffff">
                <i class="fas fa-quote-left"></i> Quotes </a>
                </div>
                <?php }else{?>
                <div class="dash-nav-dropdown" class="dash-nav-dropdown">
                <a href="manage_quotes.php" class="dash-nav-item">
                <i class="fas fa-quote-left"></i> Quotes </a>
                </div>
                ...
                <?php 
                $directoryURI =basename($_SERVER['SCRIPT_NAME']);
                if($directoryURI=="manage_today.php"){?>
                <div class="dash-nav-dropdown show" class="dash-nav-dropdown">
                <a href="manage_today.php" class="dash-nav-item" style="color: #ffffff">
                <i class="fas fa-quote-left"></i> Today Quotes </a>
                </div>
                <?php }else{?>
                <div class="dash-nav-dropdown" class="dash-nav-dropdown">
                <a href="manage_today.php" class="dash-nav-item">
                <i class="fas fa-quote-left"></i> Today Quotes </a>
                </div>
