...
<main class="dash-content">
  <div class="col-lg-12">
    <div class="col-lg-12">
      <h3 class="dash-title">Manage Images  
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Modal Images</h4>
        ...
        <form id="category-form">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input v-on:change.prevent='imageList' type="file" class="form-control" id="wallpaper" multiple/>
                <div class="invalid-feedback">
      ...
      <div class="col-lg-12">
        <div class="card easion-card">
          <div class="card-header">
            ...
            <div class="easion-card-title">All Images</div>
          </div>
          <div class="card-body ">
...
<script>
    ...
    var dbCategories = firebase.database().ref("imagecategory");
        ...
        uploadTask.on("state_changed", 
            ...
            function complete(){
                uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                    var database = firebase.database().ref("photos");
...
<script type="text/javascript">
    ...
    var dbCategories = firebase.database().ref("photos");
