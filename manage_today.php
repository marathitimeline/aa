...
<main class="dash-content">
    <!-- // This Admin panel is Crated by G-devs (Codecanyon.net) -->
                <div class="container-fluid">
                    <h1 class="dash-title">Quote of the day</h1>
                    <div class="row">
                        <div class="col-xl-12">
                ...
                <label for="title">Developers</label>
                <input type="text" class="form-control" id="title" value="YMG Developers" disabled="" />
...
<!-- // This Admin panel is Crated by G-devs (Codecanyon.net) -->
            <div class="form-group col-md-12">
                <label for="desc">Enter Your Quote</label>
            ...
            <div class="form-group col-md-12">
                <div class="progress">
                    <div class="progress-bar" id="progress" style="width:0%;">0%</div>
                                       ...
                                       <h4 id="">Today Quotes - of the day</h4>
                                       <p id="category"></p>
                ...
                <button type="button" id="btn-save" class="btn btn-primary" >Save Quote</button>
    ...
    $("#btn-save").click(function(){
        ...
        if(!desc){
            ...
            return; 
                    ...
                    var database = firebase.database().ref("quoteoftheday");
...
<script type="text/javascript">
    var userDataRef = firebase.database().ref("quoteoftheday/ymg").orderByKey();
userDataRef.once("value").then(function(snapshot) {
snapshot.forEach(function(childSnapshot) {
  var key = childSnapshot.key;

  var name_val = childSnapshot.val().desc;
